data2 = readtable("Biomechanical_Data_column_2C_weka.csv");

[train_ind, val_ind, test_ind] = dividerand(310,0.6774,0.0,0.3226);

train_data2 = data2(train_ind, :);
test_data2 = data2(test_ind, :);

decisiontree_data2_5 = fitctree(train_data2, 'class', 'MinLeafSize', 5);
decisiontree_data2_10 = fitctree(train_data2, 'class', 'MinLeafSize', 10);
decisiontree_data2_15 = fitctree(train_data2, 'class', 'MinLeafSize', 15);
decisiontree_data2_20 = fitctree(train_data2, 'class', 'MinLeafSize', 20);
decisiontree_data2_25 = fitctree(train_data2, 'class', 'MinLeafSize', 25);

view(decisiontree_data2_5, 'Mode', 'graph');
view(decisiontree_data2_10, 'Mode', 'graph');
view(decisiontree_data2_15, 'Mode', 'graph');
view(decisiontree_data2_20, 'Mode', 'graph');
view(decisiontree_data2_25, 'Mode', 'graph');

predicted_data2_5 = predict(decisiontree_data2_5, test_data2);
predicted_data2_10 = predict(decisiontree_data2_10, test_data2);
predicted_data2_15 = predict(decisiontree_data2_15, test_data2);
predicted_data2_20 = predict(decisiontree_data2_20, test_data2);
predicted_data2_25 = predict(decisiontree_data2_25, test_data2);

actual_data2 = table2array(test_data2(:, 7));
actual_data2_norm(strcmp(actual_data2, 'Abnormal')) = 0;
actual_data2_norm(strcmp(actual_data2, 'Normal')) = 1;

predicted_data2_5_norm(strcmp(predicted_data2_5, 'Abnormal')) = 0;
predicted_data2_5_norm(strcmp(predicted_data2_5, 'Normal')) = 1;
predicted_data2_10_norm(strcmp(predicted_data2_10, 'Abnormal')) = 0;
predicted_data2_10_norm(strcmp(predicted_data2_10, 'Normal')) = 1;
predicted_data2_15_norm(strcmp(predicted_data2_15, 'Abnormal')) = 0;
predicted_data2_15_norm(strcmp(predicted_data2_15, 'Normal')) = 1;
predicted_data2_20_norm(strcmp(predicted_data2_20, 'Abnormal')) = 0;
predicted_data2_20_norm(strcmp(predicted_data2_20, 'Normal')) = 1;
predicted_data2_25_norm(strcmp(predicted_data2_25, 'Abnormal')) = 0;
predicted_data2_25_norm(strcmp(predicted_data2_25, 'Normal')) = 1;

plotconfusion(actual_data2_norm, predicted_data2_5_norm);
plotconfusion(actual_data2_norm, predicted_data2_10_norm);
plotconfusion(actual_data2_norm, predicted_data2_15_norm);
plotconfusion(actual_data2_norm, predicted_data2_20_norm);
plotconfusion(actual_data2_norm, predicted_data2_25_norm);
